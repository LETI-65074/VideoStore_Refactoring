...
public class Customer
{
	...
	public String statement()
	{
		...
		for (Rental each : _rentals)
			result += "\t" + each.getMovie().getTitle() + "\t" + each.getMovie().getPrice()._code.getRentalAmount(each.getDaysRented()) + "\n";
	...
	public String htmlStatement()
	{
		...
		result += "<ul>\n";
		for (Rental each : _rentals)
			result += "\t<li>" + each.getMovie().getTitle() + "\t" +  each.getMovie().getPrice()._code.getRentalAmount(each.getDaysRented()) +"\n";
		result += "</ul>\n";
	...
	public double getTotalAmount()
	{
		...
		for (Rental each : _rentals)
			totalAmount += each.getMovie().getPrice()._code.getRentalAmount(each.getDaysRented());
		return totalAmount;
	}
